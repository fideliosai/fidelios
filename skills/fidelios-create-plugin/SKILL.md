---
name: fidelios-create-plugin
description: >
  Create new FideliOS plugins with the current alpha SDK/runtime. Use when
...
# Create a FideliOS Plugin

Use this skill when the task is to create, scaffold, or document a FideliOS plugin.
...
- is installed into FideliOS from an absolute local path during development
