# FideliOS API Reference

Detailed reference for the FideliOS control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "FideliOS Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "fidelios-mobile",
    "cwd": "/Users/me/fidelios-mobile",
    "repoUrl": "https://github.com/acme/fidelios-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `fidelios-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
