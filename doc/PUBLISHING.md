...
Low-level reference for how FideliOS packages are prepared and published to npm.
...
FideliOS no longer uses release branches or Changesets for publishing.
...
FideliOS uses calendar versions:
