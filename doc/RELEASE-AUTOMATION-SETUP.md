...
This document covers the GitHub and npm setup required for the current FideliOS release model:
...
Do this for every public package that FideliOS publishes.
...
2. revoke any personal automation token that used to publish FideliOS
