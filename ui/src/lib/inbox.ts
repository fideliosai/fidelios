...
export const DISMISSED_KEY = "fidelios:inbox:dismissed";
export const READ_ITEMS_KEY = "fidelios:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "fidelios:inbox:last-tab";
