...
import type { PluginCategory, PluginStatus, FideliOSPluginManifestV1 } from "@fideliosai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<FideliOSPluginManifestV1>().notNull(),
