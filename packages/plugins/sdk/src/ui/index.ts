/**
 * `@fideliosai/plugin-sdk/ui` — FideliOS plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@fideliosai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@fideliosai/plugin-sdk/ui";
 *
