 ...
 *
 * These components are exported from `@fideliosai/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@fideliosai/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function FideliOSSdkUiComponent(props: TProps) {
