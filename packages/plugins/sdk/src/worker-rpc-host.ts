...
import type { FideliOSPluginManifestV1 } from "@fideliosai/shared";

import type { FideliOSPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@fideliosai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: FideliOSPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@fideliosai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
