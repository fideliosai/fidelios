 ...
 * channel.
 *
 * The FideliOS plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all FideliOS messages.
 */
...
/**
 * FideliOS plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this FideliOS instance. */
    instanceId: string;
    /** Semver version of the running FideliOS host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
