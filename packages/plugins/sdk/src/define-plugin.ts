/**
 * `definePlugin` — the top-level helper for authoring a FideliOS plugin.
 *
...
// ---------------------------------------------------------------------------
// FideliOSPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface FideliOSPlugin {
 ...
 * @returns A sealed `FideliOSPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@fideliosai/plugin-sdk";
