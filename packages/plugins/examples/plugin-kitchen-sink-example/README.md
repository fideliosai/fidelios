...
Or install it from the FideliOS plugin manager as a bundled example once this repo is built.
...
- Some SDK-defined host surfaces still depend on the FideliOS host wiring them visibly; this package aims to exercise the currently mounted ones and make the rest obvious.
