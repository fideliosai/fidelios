...
const manifest: FideliOSPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current FideliOS plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "FideliOS",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the FideliOS domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
