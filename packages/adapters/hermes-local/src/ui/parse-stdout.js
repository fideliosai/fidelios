 ...
 * FideliOS uses this to match them in normalizeTranscript.
 */
...
export function parseHermesStdoutLine(line, ts) {
    ...
    if (trimmed.startsWith("[hermes]") || trimmed.startsWith("[fidelios]")) {
    ...
    // Emit as stderr so FideliOS groups them into the amber accordion.
