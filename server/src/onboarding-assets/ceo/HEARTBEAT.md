...
Run this checklist on every heartbeat. This covers both your local planning/memory work and your organizational coordination via the FideliOS skill.
...
If `FIDELIOS_APPROVAL_ID` is set:
...
- Use `fidelios-create-agent` skill when hiring new agents.
