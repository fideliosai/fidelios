...
import { companySecrets, companySecretVersions } from "@fideliosai/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@fideliosai/shared";
import { envBindingSchema } from "@fideliosai/shared";
