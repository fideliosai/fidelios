...
export function issueRoutes(db: Db, storage: StorageService) {
  ...
  // Resolve issue identifiers (e.g. "TST-39") to UUIDs for all /issues/:id routes
  ...
  // Resolve issue identifiers (e.g. "TST-39") to UUIDs for company-scoped attachment routes.
