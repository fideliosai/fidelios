...
import { models as codexFallbackModels } from "@fideliosai/adapter-codex-local";
import { models as cursorFallbackModels } from "@fideliosai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@fideliosai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.FIDELIOS_OPENCODE_COMMAND = "__fidelios_missing_opencode_command__";
